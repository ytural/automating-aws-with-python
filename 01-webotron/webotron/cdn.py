# -*- coding: utf-8 -*-
"""Classes for Cloud Front Distribution ."""
from uuid import uuid4


class DistributionManager:
    """Manage an Cloud Front Distribution."""
    ...
    def create_dist(self, domain_name, certificate):
        """Create a distribution matching domain_name using certificate."""
